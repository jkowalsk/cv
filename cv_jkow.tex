...
%\job{Ingénieur en cryptographie chez Mobiquant }
%{03/09 - 05/09 }
%{- recherche de failles de sécurité sur le produit existant\\
%\> - conception et développement de solutions de sécurisation pour ce produit
%}
%
%\job{Ingénieur crypto-mathématicien au Ministère de la Défense }
%{\ \  2004 - 2009 }
%{  Habilitation niveau secret défense\\
%\> - \textbf{Conception et développement de produits de sécurité :}
%   Etude du besoin et des menaces associées ; \\
%\> Conception et développement de solutions de sécurité; de bibliothèques cryptographiques\\
%\> - \textbf{Analyse de solutions de sécurité : }\\
%\> Etudes de sécurité inspirées des méthodes Critères Communs ;
% Méthode EBIOS\\
%\> - \textbf{Evaluation de produits civils :}
%Suivi technique d'évaluation de produits de sécurité
%}

\cventry{2004--2009 }{Ingénieur crypto-mathématicien}{Ministère de la Défense}{}{}{Habilitation niveau secret défense
\begin{itemize}
\item \textbf{Conception et développement de produits de sécurité :} 
	\begin{itemize}
	\item \'Etude du besoin et des menaces associées
	\item Conception et développement de solutions de sécurité; de bibliothèques cryptographiques
	\end{itemize}
